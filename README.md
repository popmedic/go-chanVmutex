...
> To get these results yourself, get the project `go get github.com/popmedic/go-chanVmutex/...`, cd into the account directory `cd $GOPATH/src/github.com/popmedic/go-chanVmutex` and run the benchmarks `go test -bench=.`.
